...
import 'package:fluttermovie/src/bloc/genrebloc/genre_bloc.dart';
...
class BuildWidgetCategory extends StatefulWidget {
  ...
  const BuildWidgetCategory({Key key, this.selectedGenres = 28})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      ...
      BlocProvider<MovieBloc>(
        create: (_) => MovieBloc()..add(MovieEventStarted(selectedGenres, '')),
      ),
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            ...
                            context
                                .read<MovieBloc>()
                                .add(MovieEventStarted(selectedGenres, ''));
                          });
                        },
                        child: Container(
